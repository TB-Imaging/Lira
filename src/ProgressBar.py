...
class TwoLayerProgress(tk.Tk):
    def __init__(self, steps, label):
        ...
        center_left_window(self, 320, 117)
        ...
        self.progressTwo = ttk.Progressbar(
            self,
            orient=tk.HORIZONTAL,
            length=300,
            mode="determinate",
        ...
        self.progressTwo.pack(pady=5, padx=10)
    ...
    def step(self, step=5):
        self.indeterminateProgress.step(step)
    ...
    def setProgressTwoPercent(self, percent):
        self.progressTwo['value'] = percent
